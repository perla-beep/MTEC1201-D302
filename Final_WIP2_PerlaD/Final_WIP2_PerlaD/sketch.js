...
function preload(){
  ...
  //laugh = loadSound('audio/laugh.mp3')
}
...
function scene2(){ // inside house
  ...
  image(couch,460,500,150,150)
  image(flowers,400,520,60,100)
  //rect(x,y,w,h)
}
...
function mousePressed(){
  ...
  if (scene == 6 && mouseX > 380 && mouseX < 423 && mouseY > 440 && mouseY<500){
    scene = 5
  }
  ...
  if(scene == 6 && mouseX < 150 && mouseX > 120 && mouseY > 430 && mouseY < 450){
    scene = 1
  }
}
